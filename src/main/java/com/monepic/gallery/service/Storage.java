...
public class Storage implements AlbumService, ImageService {
	...
	private Map<UUID, Album> albumMap = Collections.emptyMap();//new HashMap<UUID, Album>();
	private Map<UUID, Image> imageMap = Collections.emptyMap();//new HashMap<UUID, Image>();
	...
	public void initializeMaps() {
		...
		new Thread() {
			public void run() {
				Map<UUID, Album> albumMap = new HashMap<UUID, Album>();
				Map<UUID, Image> imageMap = new HashMap<UUID, Image>();
				...
				Storage.this.albumMap = albumMap;
				Storage.this.imageMap = imageMap;
			}
		}.start();
	}
